...
@section('content')
    <section class="container">
        <div class="mb-3 text-center border-bottom">
            <h1 class="display-4 fw-bold">Список задач</h1>
        </div>
            ...
            @else
                <div class="p-5 mb-4 bg-light rounded-3">
                    <div class="container-fluid py-5">
                        Пока не было создано ни одной задачи! Будьте первым!
                    </div>
                </div>
            @endif
    ...
    @guest
        <div class="p-5 mb-4 bg-light rounded-3">
            <div class="container-fluid py-5">
                <h1 class="display-5 fw-bold">Чтобы оставить задачу, Вам необходимо зарегистрироваться</h1>
            </div>
        </div>
        @else
